...
(function() {
    ...
    TwitterBot = (function(_super) {
        ...
        TwitterBot.prototype.post = function(endpoint, options, callback) {
            return this.twitter.post(endpoint, options, function(err, data, response) {
                if (callback && typeof callback === "function") {
        ...
        TwitterBot.prototype.get = function(endpoint, options, callback) {
            return this.twitter.get(endpoint, options, function(err, data, response) {
                if (callback && typeof callback === "function") {
                    return callback(err, data, response);
                }
            });
